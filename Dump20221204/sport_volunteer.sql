...
CREATE TABLE `volunteer` (
  ...
  `account` varchar(45) COLLATE utf8mb3_bin DEFAULT NULL,
  `password` varchar(45) COLLATE utf8mb3_bin DEFAULT NULL,
  `server` varchar(45) COLLATE utf8mb3_bin DEFAULT NULL,
  `project_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_volunteer_1_idx` (`project_id`),
  CONSTRAINT `fk_volunteer_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`)
